...
<body>
	...
	<table cellpadding="10">
		<tr>
			<td>First Name:</td>
			<td><input type="text" name="First_name" placeholder="Enter First name..." maxlength="23"> (Max lenghth 23 Char) </td>
		</tr>
		<tr>
			<td>Last Name:</td>
			<td><input type="text" name="Last_name" placeholder="Enter Last name..." maxlength="23"> (Max lenghth 23 Char) </td>
		</tr>
		<tr>
			<td>
				Date of Birth
		...
		<tr>
			...
			<td>
				<input type="text" name="email" maxlength="45" placeholder="123434@gmail.com">
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<input type="Char" name="contect_number" placeholder="03084185338">
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				...
				Foot ball <input type="checkbox" name="Hobbies">
				Other <input type="text" name="Hobbies">
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				BSCS<input type="radio" name="course" <?php if (isset($gender) && $gender=="female") echo "checked";?>>
				BSSE<input type="radio" name="course">
				BSIT<input type="radio" name="course">
				BSC<input type="radio" name="course">
			</td>
		</tr>
		<tr>
